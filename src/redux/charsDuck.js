...
import {updateBD, getFavs} from '../firebase'
...
export default function reducer(state= initialData,action) {
   switch(action.type){
       ...
       case GET_FAVS_SUCCESS:
           let newArray = state.array.filter(elem => {
              return !action.payload.find(fav => fav.name == elem.name)
           })
           return {...state, array: newArray, favorites:action.payload, fetching:false }
       case GET_FAVS_ERROR:
